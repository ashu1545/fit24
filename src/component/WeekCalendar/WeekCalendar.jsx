...
import { sameWeek, onSameDateRange, getWeekDates } from 'src/dateutils';
import { toMarkingFormat } from 'src/interface';
import styleConstructor from 'src/expandableCalendar/style';
import WeekDaysNames from 'src/commons/WeekDaysNames';
import Week from 'src/expandableCalendar/week';
import { UpdateSources } from 'src/expandableCalendar/commons';
import constants from 'src/commons/constants';
import { extractCalendarProps } from 'src/componentUpdater';
...
const WeekCalendar = (props) => {
    ...
    return (
        // renderWeekDaysNames - Days of the week
