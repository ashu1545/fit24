  ...
  return (
    <GestureHandlerRootView style={{ flex: 1 }}>
      <LayoutWithoutScrollView backgroundColor={'#EB8F63'}>
        ...
        <View style={{ width: 92, height: 92, borderRadius: 50, alignItems: 'center', alignSelf: 'center' }}>
          <JumpingJack />
        </View>
      ...
      <LayoutForBottomSheet>
        <DisplayHeader
          ...
          left={<>
            ...
            <Text style={{ color: '#EB8F63' }}>11 Exercises | 32mins | 320 Calories Burn</Text>
          </>}
          right={<LoveIcon />}
        />

        <View style={{ backgroundColor: '#F1DDD3', borderRadius: 20, paddingHorizontal: 10 }}>
          <DisplayHeader
            left={
              <HeaderLeftContent
        ...
        <LinearGradient
          ...
          <DisplayHeader
            ...
            marginTop={20}
            right={<View style={{ flexDirection: 'row' }}>
              <Text style={{ color: '#EB8F63', marginRight: 9 }}>Beginner</Text>
              <ArrowIcon />
            </View>}
          />
        </LinearGradient>
