import { StyleSheet, Text, View, Image, ImageBackground, TouchableOpacity, DrawerLayoutAndroid } from 'react-native'
...
const MainDashboard = ({navigation}) => {
  ...
  return (
    <Layout>
      ...
      <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-around', marginTop: 15, marginBottom: 10 }}>
        <View style={{
          width: '45%',
          backgroundColor: '#fff',
          borderRadius: 20,
        ...
        <View style={{ flex: 1, flexDirection: 'column', justifyContent: 'space-between', marginLeft: 23 }}>
          <StatusCard
            img={<SleepGraph width={'100%'} height={78} style={{ marginTop: 25 }} />}
            title={'Sleep'}
            subtitle={'8h 20m'}
          />
          <View style={{ marginTop: 10, marginBottom: 10 }} />
          <StatusCard
            img={<CaloriesPie width={'100%'} height={120} style={{ marginTop: 10 }} />}
            title={'Calories'}
            subtitle={'760 kCal'}
          />
        </View>
