...
const JumpingJack = () => {
  ...
  return (
    <Layout>
      ...
      <View>
        <Text style={{ color: '#FFFFFF', marginBottom: 5, lineHeight: 24, fontSize: 16, fontWeight: 'semibold' }}>Jumping Jack</Text>
        <Text style={{ color: '#D9D9D9', fontSize: 12, lineHeight: 18, fontWeight: 'regular' }}>Easy | 390 Calories Burn</Text>
      </View>

      <View>
        <Text style={{ color: '#FFFFFF', marginBottom: 5, lineHeight: 24, fontSize: 16, fontWeight: 'semibold', marginTop: 30 }}>Descriptions</Text>
        <Text style={{ color: '#D9D9D9', fontSize: 12, lineHeight: 18, fontWeight: 'mixed' }}>
          A jumping jack, also known as a star jump and called a side-straddle hop in the US military, is a physical jumping exercise performed by jumping to a position with the legs spread wide <Text style={{ color: '#EB8F63' }}>Read More...</Text>
        </Text>
      </View>

      <DisplayHeader
        left={<HeaderText>How To Do It</HeaderText>}
        right={<Text style={{ color: '#D9D9D9', fontSize: 12, lineHeight: 18 }}>4 Steps</Text>}
      />
      ...
      <Text style={{ marginTop: 40, color: '#FFFFFF', lineHeight: 24, fontSize: 16, fontWeight: 'semibold', marginBottom: 20 }}>Custom Repetitions</Text>
      ...
      />
      <View style={{ width: '100%', height: 0.4, backgroundColor: '#DDDADA' }} />
      ...
      <CustomRepetitions
        ...
        paddingLeft={25}
        times={'times'}
        horizontalLine={<View style={{ width: '100%', height: 0.4, backgroundColor: '#DDDADA' }} />}
      />
